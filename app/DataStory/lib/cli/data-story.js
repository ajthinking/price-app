...
/***/ "./src/utils/nonCircularJsonStringify.ts":
/*!***********************************************!*\
  !*** ./src/utils/nonCircularJsonStringify.ts ***!
  \***********************************************/
...
var Obj_1 = __webpack_require__(/*! ./utils/Obj */ "./src/utils/Obj.js");
...
function () {
  function ServerDiagram() {
    this.links = [];
    this.nodes = [];
    this.cachedNodeDependencyMap = {// id1: [d1, d2, ...]
    };
  }
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_d) {
        switch (_d.label) {
          ...
          case 2:
            if (!(_c = _d.sent(), !_c.done)) return [3
            /*break*/
            , 5];
            node = _c.value;
            return [4
          ...
          case 7:
            ...
            if (!(_c && !_c.done && (_a = _b["return"]))) return [3
            /*break*/
            , 9];
            return [4
            /*yield*/
...
var UID_1 = __webpack_require__(/*! ../utils/UID */ "./src/utils/UID.js");

var NodeParameter_1 = __webpack_require__(/*! ../NodeParameter */ "./src/NodeParameter.js");
...
function () {
  ...
  ServerNode.prototype.getParameters = function () {
    return [NodeParameter_1["default"].string('node_name').withValue(this.name)];
  };
...
/***/ "./src/server/ServerNodeFactory.js":
/*!*****************************************!*\
  !*** ./src/server/ServerNodeFactory.js ***!
  \*****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var Aggregate_1 = __webpack_require__(/*! ./nodes/Aggregate */ "./src/server/nodes/Aggregate.js");

var Clone_1 = __webpack_require__(/*! ./nodes/Clone_ */ "./src/server/nodes/Clone_.js");

var Comment_1 = __webpack_require__(/*! ./nodes/Comment */ "./src/server/nodes/Comment.js");

var Create_1 = __webpack_require__(/*! ./nodes/Create */ "./src/server/nodes/Create.js");

var CreateGrid_1 = __webpack_require__(/*! ./nodes/CreateGrid */ "./src/server/nodes/CreateGrid.js");

var CreateAttribute_1 = __webpack_require__(/*! ./nodes/CreateAttribute */ "./src/server/nodes/CreateAttribute.js");

var CreateCSV_1 = __webpack_require__(/*! ./nodes/CreateCSV */ "./src/server/nodes/CreateCSV.js");

var CreateJSON_1 = __webpack_require__(/*! ./nodes/CreateJSON */ "./src/server/nodes/CreateJSON.js");

var CreateSequence_1 = __webpack_require__(/*! ./nodes/CreateSequence */ "./src/server/nodes/CreateSequence.js"); // import DownloadCSV from './nodes/DownloadCSV'
// import DownloadJSON from './nodes/DownloadJSON'
// import DownloadGeoJSON from './nodes/DownloadGeoJSON'


var Evaluate_1 = __webpack_require__(/*! ./nodes/Evaluate */ "./src/server/nodes/Evaluate.js");

var FilterDuplicates_1 = __webpack_require__(/*! ./nodes/FilterDuplicates */ "./src/server/nodes/FilterDuplicates.js");

var Flatten_1 = __webpack_require__(/*! ./nodes/Flatten */ "./src/server/nodes/Flatten.js");

var Group_1 = __webpack_require__(/*! ./nodes/Group */ "./src/server/nodes/Group.js"); // import HTTPRequest from './nodes/HTTPRequest'


var Inspect_1 = __webpack_require__(/*! ./nodes/Inspect */ "./src/server/nodes/Inspect.js");

var Log_1 = __webpack_require__(/*! ./nodes/Log */ "./src/server/nodes/Log.js");

var Map_1 = __webpack_require__(/*! ./nodes/Map */ "./src/server/nodes/Map.js");

var OutputProvider_1 = __webpack_require__(/*! ./nodes/OutputProvider */ "./src/server/nodes/OutputProvider.js");

var RegExpFilter_1 = __webpack_require__(/*! ./nodes/RegExpFilter */ "./src/server/nodes/RegExpFilter.js"); // import DeleteRepositories from './nodes/github/DeleteRepositories'
// import Repositories from './nodes/github/Repositories'


var Sample_1 = __webpack_require__(/*! ./nodes/Sample */ "./src/server/nodes/Sample.js");

var Sort_1 = __webpack_require__(/*! ./nodes/Sort */ "./src/server/nodes/Sort.js");

var Sleep_1 = __webpack_require__(/*! ./nodes/Sleep */ "./src/server/nodes/Sleep.js");

var ThrowError_1 = __webpack_require__(/*! ./nodes/ThrowError */ "./src/server/nodes/ThrowError.js");

var ServerNodeFactory =
/** @class */
function () {
  ...
  ServerNodeFactory.hydrate = function (node, diagram) {
    ...
    return new type(__assign(__assign({}, node), {
      diagram: diagram
    }));
  };
...
var ServerNode_1 = __webpack_require__(/*! ../ServerNode */ "./src/server/ServerNode.js");

var NodeParameter_1 = __webpack_require__(/*! ../../NodeParameter */ "./src/NodeParameter.js");

var Arr_1 = __webpack_require__(/*! ../../utils/Arr */ "./src/utils/Arr.js");

var Feature_1 = __webpack_require__(/*! ../../Feature */ "./src/Feature.js");
...
function (_super) {
  ...
  Aggregate.prototype.run = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_b) {
        ...
        key = __spreadArrays(['original'], groupKey ? [groupKey] : []).join('.');
        groups = Arr_1.groupBy(this.input(), key);
        features = [];

        for (value in groups) {
          features.push(new Feature_1.Feature((_a = {}, _a[groupKey] = value, _a.features = groups[value].map(function (feature) {
  ...
  Aggregate.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].string('group_by')]);
  };
...
function (_super) {
  ...
  Clone_.prototype.run = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        this.output(__spreadArrays([this.input()], Array(parseInt(this.getParameterValue('number_of_clones'))).fill(this.input())).flat());
        return [2
        /*return*/
        ];
      });
  ...
  Clone_.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].number('number_of_clones').withValue(10)]);
  };
...
function (_super) {
  ...
  Comment.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].string('text').withValue('This is a comment')]);
  };
...
function (_super) {
  ...
  Create.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].select('feature_type').withOptions(['null', 'object', 'float', 'integer', 'string']).withValue('object'), NodeParameter_1["default"].json('contents').withValue('{}')]);
  };
...
/***/ "./src/server/nodes/CreateAttribute.js":
/*!*********************************************!*\
  !*** ./src/server/nodes/CreateAttribute.js ***!
  \*********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
function (_super) {
  ...
  CreateAttribute.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].string('attribute'), NodeParameter_1["default"].string('value')]);
  };
...
function (_super) {
  ...
  CreateCSV.prototype.run = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        this.output(objects.map(function (o) {
          return new Feature_1.Feature(o);
        }));
        return [2
        /*return*/
        ];
  ...
  CreateCSV.prototype.parseValue = function (value) {
    ...
    if (isNaN(value)) return value; // Its numeric

    if (!Number.isNaN(parseFloat(value))) return parseFloat(value);
    if (!Number.isNaN(parseInt(value))) return parseInt(value); // Fallback
...
/***/ "./src/server/nodes/CreateGrid.js":
/*!****************************************!*\
  !*** ./src/server/nodes/CreateGrid.js ***!
  \****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
function (_super) {
  ...
  CreateGrid.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].select('grid_type').withOptions(['points', 'boxes']).withValue('points'), NodeParameter_1["default"].number('grid_min_x').withValue(0), NodeParameter_1["default"].number('grid_min_y').withValue(0), NodeParameter_1["default"].number('grid_max_x').withValue(10), NodeParameter_1["default"].number('grid_max_y').withValue(10), NodeParameter_1["default"].number('grid_size_x').withDescription('Ignored if grid_max_x is set'), NodeParameter_1["default"].number('grid_size_y').withDescription('Ignored if grid_max_y is set'), NodeParameter_1["default"].number('grid_spacing_x').withValue(1), NodeParameter_1["default"].number('grid_spacing_y').withValue(1)]);
  };
...
/***/ "./src/server/nodes/CreateJSON.js":
/*!****************************************!*\
  !*** ./src/server/nodes/CreateJSON.js ***!
  \****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
function (_super) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        this.output(JSON.parse(this.getParameterValue('features')).map(function (item) {
          return new Feature_1.Feature(item);
        }));
        return [2
        /*return*/
        ];
  ...
  CreateJSON.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].json('features').withValue('[{ "resource": "todos"}]')]);
  };
...
/***/ "./src/server/nodes/CreateSequence.js":
/*!********************************************!*\
  !*** ./src/server/nodes/CreateSequence.js ***!
  \********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
function (_super) {
  ...
  CreateSequence.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].number('number_of_features_to_create').withValue(10)]);
  };
...
function (_super) {
  ...
  Evaluate.prototype.run = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        return [2
        /*return*/
        , this.getParameterValue('evaluation_context') == 'per_feature' ? this.runPerFeature() : this.runGlobal()];
      });
    });
  };
  ...
  Evaluate.prototype.runPerFeature = function () {
    ...
    this.output(inputs.map(function (current, index) {
      var _a, _b; // previous and next have 'null' features as fallback
  ...
  Evaluate.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].select('evaluation_context').withOptions(['per_feature', 'global']).withValue('per_feature'), NodeParameter_1["default"].js('expression').withDescription("javascript code to execute").withValue(placeholder)]);
  };
...
/***/ "./src/server/nodes/FilterDuplicates.js":
/*!**********************************************!*\
  !*** ./src/server/nodes/FilterDuplicates.js ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
function (_super) {
  ...
  FilterDuplicates.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].string('attribute').withDescription("attribute to filter on, may use dot notation")]);
  };
...
function (_super) {
  ...
  Group.prototype.run = function () {
    return __awaiter(this, void 0, void 0, function () {
      return __generator(this, function (_a) {
        this.output([new Feature_1.Feature(this.input().map(function (f) {
          return f.original;
        }))]);
        return [2
        /*return*/
...
function (_super) {
  ...
  Map.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].string('property').withValue('data')]);
  };
...
/***/ "./src/server/nodes/OutputProvider.js":
/*!********************************************!*\
  !*** ./src/server/nodes/OutputProvider.js ***!
  \********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
function (_super) {
  ...
  OutputProvider.prototype.run = function () {
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_c) {
        outputs = this.getParameterValue('outputs') ? this.getParameterValue('outputs') : {}; // It can accept json string or object
        ...
        for (_i = 0, _a = Object.entries(outputs); _i < _a.length; _i++) {
          ...
          this.output(value.map(function (v) {
            return new Feature_1.Feature(v);
          }), key);
        }
  ...
  OutputProvider.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].js('outputs').withValue('')]);
  };
...
/***/ "./src/server/nodes/RegExpFilter.js":
/*!******************************************!*\
  !*** ./src/server/nodes/RegExpFilter.js ***!
  \******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var ServerNode_1 = __webpack_require__(/*! ../ServerNode */ "./src/server/ServerNode.js"); // @ts-ignore


var Str_1 = __webpack_require__(/*! ../../utils/Str */ "./src/utils/Str.js");
...
function (_super) {
  ...
  RegExpFilter.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].string('attribute').withValue(''), NodeParameter_1["default"].string('expression').withValue('/test|draft|dummy/')]);
  };
...
function (_super) {
  ...
  Sample.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].number('first_n_features').withValue(100)]);
  };
...
function (_super) {
  ...
  Sleep.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].number('seconds_to_sleep').withValue(5)]);
  };
...
function (_super) {
  ...
  Sort.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].select('sort_context').withOptions(["global"
    /*, "local"*/
    ]).withValue('global'), NodeParameter_1["default"].string('sort_attribute').withDescription("attribute to sort on, may use dot notation")]);
  };
...
/***/ "./src/server/nodes/ThrowError.js":
/*!****************************************!*\
  !*** ./src/server/nodes/ThrowError.js ***!
  \****************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
function (_super) {
  ...
  ThrowError.prototype.getParameters = function () {
    return __spreadArrays(_super.prototype.getParameters.call(this), [NodeParameter_1["default"].string('error_message').withValue('Something went wrong!')]);
  };
...
var Obj_1 = __webpack_require__(/*! ./Obj */ "./src/utils/Obj.js");

exports.groupBy = function (items, key) {
  return items.reduce(function (result, item) {
    var _a;

    return __assign(__assign({}, result), (_a = {}, _a[Obj_1.get(item, key)] = __spreadArrays(result[Obj_1.get(item, key)] || [], [item]), _a));
  }, {});
};
...
var ServerDiagram_1 = __importDefault(__webpack_require__(/*! ../server/ServerDiagram */ "./src/server/ServerDiagram.js"));

var ServerNodeFactory_1 = __importDefault(__webpack_require__(/*! ../server/ServerNodeFactory */ "./src/server/ServerNodeFactory.js"));

var nonCircularJsonStringify_1 = __webpack_require__(/*! ../utils/nonCircularJsonStringify */ "./src/utils/nonCircularJsonStringify.ts");
...
var boot = function boot() {
  var result = JSON.stringify({
    stories: [],
    availableNodes: ServerNodeFactory_1["default"].all().map(function (node) {
...
var run = function run(serializedDiagram) {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return ServerDiagram_1["default"].hydrate(JSON.parse(serializedDiagram), ServerNodeFactory_1["default"]).run();
